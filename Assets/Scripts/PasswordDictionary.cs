...
public class PasswordDictionary : MonoBehaviour
{
    Dictionary<int, string> goodPasswords =  new Dictionary<int, string>()
    {
    ...
    Dictionary<int, string[]> badPasswords =  new Dictionary<int, string[]>();
